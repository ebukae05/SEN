...
def test_full_pipeline() -> bool:
    ...
    try:
        ...
        result = run_pipeline(engine_id=1, dataset_id=DATASET_ID)
...
def test_pdf_report_exists() -> bool:
    ...
    try:
        report_path = Path(__file__).parent.parent / "data" / "processed" / "reports" / f"engine_1_{DATASET_ID}_report.pdf"
